...
namespace PI2EmAspNet.Controllers
{
    ...
    {
        private readonly DiretorServices _ds;

        public DiretorController(DiretorServices ds) {
            _ds = ds;
        }
        ...
        public async Task<IActionResult> Details(int? id) {
            ...
            var diretor = await _ds.FindByIdAsync(id.Value);
        ...
        public async Task<IActionResult> Create(Diretor diretor) {
            if (ModelState.IsValid) {
                await _ds.CreateAsync(diretor);
